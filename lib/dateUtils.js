...
/**
 * Format a date/time string in Philippines timezone (Asia/Manila)
 * @param {string|Date|null|undefined} dateValue - The date value to format
 * @param {object} options - Intl.DateTimeFormat options
 * @returns {string} Formatted date/time string or 'N/A'
 */
export function formatDatePH(dateValue, options = {}) {
    const date = safeDate(dateValue);
...
/**
 * Format a date only (no time) in Philippines timezone
 * @param {string|Date|null|undefined} dateValue - The date value to format
 * @param {object} options - Intl.DateTimeFormat options
 * @returns {string} Formatted date string or 'N/A'
 */
export function formatDateOnlyPH(dateValue, options = {}) {
    const date = safeDate(dateValue);
...
/**
 * Format a time only in Philippines timezone
 * @param {string|Date|null|undefined} dateValue - The date value to format
 * @param {object} options - Intl.DateTimeFormat options
 * @returns {string} Formatted time string or 'N/A'
 */
export function formatTimePH(dateValue, options = {}) {
    const date = safeDate(dateValue);
